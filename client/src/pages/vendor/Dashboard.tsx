...
export default function VendorDashboard() {
  ...
  const stats = [
    ...
    { title: "Active Products", value: "85", icon: FaBox, color: "text-purple-600", bg: "bg-purple-50", trend: "+2" },
    { title: "Customer Rating", value: "4.8/5", icon: FiUsers, color: "text-amber-600", bg: "bg-amber-50", trend: "Top 5%" },
  ];
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1 font-medium">
            Welcome back, <span className="text-gray-800">Premium Fashion Store</span>. Here's what's happening today.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-[#852BAF] to-[#FC3F78] text-white font-semibold rounded-xl hover:opacity-90 transition-all shadow-lg shadow-purple-200">
            <FaPlus size={14} />
            Add Product
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        {stats.map((item, idx) => (
          <div key={idx} className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow group">
            ...
            <div className="mt-4">
              <p className="text-sm font-semibold text-gray-400 uppercase tracking-wider">{item.title}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="p-6 border-b border-gray-50 flex justify-between items-center">
            ...
            <button className="text-[#852BAF] text-sm font-bold hover:underline">View All</button>
          </div>
                  ...
                  <tr key={order} className="hover:bg-gray-50/50 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-semibold text-gray-700 text-sm">Designer Silk Saree</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 text-sm text-gray-600">Rahul Sharma</td>
                    <td className="px-6 py-4">
                      <span className="px-3 py-1 text-xs font-bold rounded-full bg-orange-50 text-orange-600">Processing</span>
                    </td>
                    <td className="px-6 py-4 font-bold text-gray-800 text-sm">₹12,499</td>
                  </tr>
                ))}
              </tbody>
            </table>
