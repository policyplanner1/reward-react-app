    ...
    <nav className="fixed top-0 left-0 h-full w-64 bg-white border-r border-gray-100 flex flex-col shadow-sm font-sans">
      ...
      <div className="p-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] uppercase tracking-widest text-[#C64EFE] font-semibold mt-1">
              Vendor Portal
            </p>
          </div>
        </div>
      ...
      ${
        isActive(child.to)
          ...
          : "text-gray-300 group-hover:text-[#852BAF]"
      }`}
                          />
      ...
      <div className="p-4 bg-gray-50/50 m-4 rounded-2xl border border-gray-100">
        ...
        <div
          className={`overflow-hidden transition-all duration-300 ${
            isProfileOpen ? "max-h-24 mt-3 opacity-100" : "max-h-0 opacity-0"
          }`}
        >
          <div className="space-y-1">
            <Link
              to="/vendor/change-password"
              className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-600 hover:bg-white rounded-lg transition-colors"
            >
              <HiOutlineUserCircle className="text-lg text-gray-400" /> change
              Password
            </Link>
            <button
              onClick={logout}
              className="flex items-center gap-2 w-full px-3 py-2 text-sm font-medium text-red-500 hover:bg-red-50 rounded-lg transition-colors cursor-pointer"
            >
